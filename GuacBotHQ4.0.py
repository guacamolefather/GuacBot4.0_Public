...
@bot.bridge_command(description="Refreshes server_data.json")
@commands.check(is_it_me)
async def refreshserverdata(ctx):
    RefreshServerData(bot)
    await ctx.respond("Refreshing server data!")

@bot.bridge_command(description="Loads the given cog.")
@commands.check(is_it_me)
...
@bot.bridge_command(description="Unloads the given cog.")
@commands.check(is_it_me)
...
@bot.bridge_command(description="Reloads the given cog.")
@commands.check(is_it_me)
...
@bot.bridge_command(description="Kills me.")
@commands.check(is_it_me)
async def die(ctx):
...
@bot.bridge_command(description="Restarts me.")
@commands.check(is_it_me)
...
@bot.bridge_command(description="Guac will send his link and a link to his server!")
